...
export default {
  ...
  methods: {
    ...
    // 随机生成img src
    getRandomImg () {
      var imgName = 'img (' + this.getRandomNumberByRange(1, 95) + ').png'
      return require('../assets/slideVerify/imgs/' + imgName)
    },
...
<style scoped>
  ...
  .slide-verify-refresh-icon {
    ...
    height: 34px;
    cursor: pointer;
    background: url("../assets/slideVerify/icon_light.png") 0 -437px;
  ...
  .slide-verify-slider-mask-item-icon {
    ...
    width: 14px;
    height: 12px;
    background: url("../assets/slideVerify/icon_light.png") 0 -26px;
    background-size: 34px 471px
  }
